...
export default function LoginPage() {
    ...
    return (
        <div className="flex min-h-screen bg-background text-foreground overflow-hidden">
            ...
            <div className="hidden lg:flex w-1/2 bg-primary/95 relative items-center justify-center overflow-hidden">
                ...
                >
                    ...
                    <h1 className="text-4xl font-bold text-white mb-6">ترند بلاس</h1>
                    <p className="text-xl text-white/80 leading-relaxed">
                        نظام ترند بلاس - شريكك الموثوق في عالم الخدمات اللوجستية. نضمن وصول شحناتك بأمان وسرعة.
                    </p>
                    <div className="mt-12 grid grid-cols-2 gap-6">
                        <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/10">
                            <Ship className="w-10 h-10 text-white/90 mx-auto mb-4" />
                            <h3 className="text-white font-semibold">شحن دولي</h3>
                        </div>
                        <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/10">
                            <Package className="w-10 h-10 text-white/90 mx-auto mb-4" />
                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    >
                        ...
                        <div className="flex justify-center gap-2">
                            <a href="tel:0923136528" className="inline-flex items-center gap-2 text-primary font-semibold hover:text-primary/80 transition-colors bg-primary/10 px-4 py-2 rounded-full">
                                <Phone className="w-4 h-4" />
                                <span dir="ltr">0923 136 528</span>
                            </a>
                            <a href="tel:0944444170" className="inline-flex items-center gap-2 text-primary font-semibold hover:text-primary/80 transition-colors bg-primary/10 px-4 py-2 rounded-full">
                                <Phone className="w-4 h-4" />
                                <span dir="ltr">0944 444 170</span>
                            </a>
                        </div>

                        <div className="mt-4 text-xs text-slate-400">
                            طبرق ، حي التحكم ، بجوار مخبز التحكم
                        </div>
                    </motion.footer>
                </div>
            </div>
